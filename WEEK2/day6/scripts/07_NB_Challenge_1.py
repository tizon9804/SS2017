...
opacityTransferFunction.AddPoint(0.5, 0.0)
opacityTransferFunction.AddPoint(0.6, 0.8)
...
for x in range(0,14):
    ...
    print(d)
    if(d == 0.0):
        colorTransferFunction.AddRGBPoint(d,0.0, 1.0, 1.0)
    elif(d<=0.1):
        colorTransferFunction.AddRGBPoint(d,0.0, 1.0, 0.0)
    elif(d<=0.6):
        colorTransferFunction.AddRGBPoint(d,1.0, 0.0, 0.0)
